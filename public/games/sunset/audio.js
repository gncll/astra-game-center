...
export class GameAudio{
 ...
 async prepare(){
  ...
  this.loading=(async()=>{
   ...
   this.city=this.loop('city',.52);this.engine=this.loop('engine',0);this.engine.source.playbackRate.value=.75;this.radios=[this.loop('radioSoul',0),this.loop('radioNight',0)];this.ready=true;this.error=null;
