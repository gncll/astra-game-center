...
class GLTFLoader extends Loader {
	...
	load( url, onLoad, onProgress, onError ) {
		...
		if ( this.resourcePath !== '' ) {
			...
			// Example  path = 'https://my-cnd-server.com/', url = 'assets/games/fine-print/models/model.gltf'
			// resourcePath = 'https://my-cnd-server.com/games/fine-print/assets/games/fine-print/models/'
			// referenced resource 'model.bin' will be loaded from 'https://my-cnd-server.com/games/fine-print/assets/games/fine-print/models/model.bin'
			// referenced resource '../textures/texture.png' will be loaded from 'https://my-cnd-server.com/games/fine-print/assets/textures/texture.png'
