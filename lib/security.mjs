...
export function validGameId(value) {
  return ['wardenfall','sunset','sidewalk','pine'].includes(value);
}
const entries = Object.freeze({ wardenfall: '/games/wardenfall/index.html', sidewalk: '/games/sidewalk/index.html', sunset: '/games/sunset/index.html', pine: '/games/pine/demo.html' });
